#include <jni.h>
#include "com_example_gp62_studymate_CameraActivity.h"
...
extern "C" {
//JNIEXPORT void JNICALL Java_com_example_gp62_studymate_CameraActivity_ConvertRGBtoGray
...
JNIEXPORT jint JNICALL Java_com_example_gp62_studymate_CameraActivity_detect
    ...
    for (int i = 0; i < faces.size(); i++) {
        ...
        Point point1(real_facesize_x,real_facesize_y);
        Point point2(real_facesize_x+real_facesize_width,real_facesize_y+real_facesize_height);

//        ellipse(img_result, center, Size( real_facesize_width / 2, real_facesize_height / 2), 0, 0, 360,
//                Scalar(255, 0, 255), 30, 8, 0);
        rectangle(img_result,point1,point2,Scalar(255, 0, 0),5,8,0);
