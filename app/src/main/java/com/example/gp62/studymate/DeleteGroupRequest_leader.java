...
public class DeleteGroupRequest_leader extends StringRequest {

    private Map<String, String> parameters;
    String Tag = "DeleteGroupRequest_leader";
    static String URL =  new Variable().getURL();

    // 생성자
    // Response.Listener : 응답받는 리스너
    public DeleteGroupRequest_leader(int group_no, Response.Listener<String> listener) {
        // 해당 url에 post방식으로 파라미터를 보낸다
        super(Method.POST, URL+"deleteGroup_leader.php", listener, null);
