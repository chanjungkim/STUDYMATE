...
public class KaKaoMapRequest extends StringRequest { // 이메일이 사용가능한지 체크

    static String SERVER_URL = new Variable().getURL();
    final static private String URL = SERVER_URL + "kakaoMap.php";
    String Tag = "KaKaoMapRequest";
    ...
    public KaKaoMapRequest(String current_longitude, String current_latitude,String keyword,int radius,Response.Listener<String> listener){
