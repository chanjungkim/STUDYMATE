...
//                        Log.e(Tag,"35551");
        ...
        Log.e(Tag, "+13");
        RequestQueue queue = Volley.newRequestQueue(GoogleMapActivity.this);
...
//                                mapItemList.get(j).setPlace_image("");
                  ...
                  studylist_btn.setVisibility(View.VISIBLE);
                    ...
                    for (int j = 0; j < mapItemList.size(); j++) {
                        Log.e(Tag,"이름이 '"+mapItemList.get(j).getPlace_name()+"' 인"+j+"번 이미지 : "+mapItemList.get(j).getPlace_image());
                    }
//                    }
//                     }else { // 주변 스터디룸 정보들을 받아올 수 없다면,
//                    Log.e(Tag,"카카오 : 주변스터디룸 정보 받아올 수 없음!");
